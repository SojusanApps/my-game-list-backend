...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="user",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="game_lists", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="user",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="games_followed", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
            model_name="game",
            name="developer",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="games", to="games.developer"
            ),
        ),
        migrations.AddField(
            model_name="game",
        ...
        migrations.AddField(
            ...
            name="publisher",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="games", to="games.publisher"
            ),
        ),
